...
/***/ function(module, exports, __webpack_require__) {
	...
	var _emailInput = __webpack_require__(17);

	var _checkInput = __webpack_require__(18);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var MODULE_NAME = 'check-input';


	_angular2.default.module(MODULE_NAME, []).directive('emailInput', _emailInput.EmailInputDirective).directive('checkInput', _checkInput.CheckInputDirective).controller('myCtrl', function ($scope) {
	  var ctrl = this;
	  ctrl.vFloat = '';
	  ctrl.vInteger = '';
	  ctrl.vUSDPrefix = '';
...
/***/ function(module, exports) {
	...
	function EmailInputDirective() {
	  ...
	  return {
	    ...
	    //template: ``,
	    link: function link(scope, element, attrs, ngModel, $timeout) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CheckInputDirective = CheckInputDirective;
	 ...
	 */
	function CheckInputDirective($parse, $timeout) {
	  'ngInject';
	  ...
	  return {
	    ...
	    link: function link($scope, $ele, $attr, ngModelCtrl) {
	      ...
	      var parser = function parser(viewValue) {
	        ...
	        var parser = rules[$attr.checkInput] || rules[''];
